...
# Input: None (Option) 상세 Input값 변경이 필요한 경우 API문서 참조
# Output: DataFrame (Option) output API 문서 참조 등
def get_overseas_inquire_balance(tr_id="TTTS3012R",excg_cd="", crcy_cd="", tr_cont="", FK100="", NK100="", dataframe=None):
...
# Input: None (Option) 상세 Input값 변경이 필요한 경우 API문서 참조
# Output: DataFrame (Option) output API 문서 참조 등
def get_overseas_inquire_ccnl(tr_id="TTTS3035R",st_dt="", ed_dt="", ord_dv="00", ccld_dv="00", excg_cd="%", tr_cont="", FK100="", NK100="", dataframe=None):
