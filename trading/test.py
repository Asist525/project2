...
# print(f"현재가: {rt_data.stck_prpr.iloc[0]}  전일대비: {rt_data.prdy_vrss.iloc[0]}")
# 출력=> 현재가: 57600  전일대비: 2800
...
# rt_data = kb.get_inquire_daily_itemchartprice(itm_no="005930")
# print(rt_data)
...
# rt_data = kb.get_inquire_asking_price_exp_ccn(output_dv="2", itm_no="005930")
# print(rt_data)
